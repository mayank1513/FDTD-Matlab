...
plasmaFreqInd = 1; rInd=1;
    
if exist('status0.mat','file'), load status0; end
...
for rInd=rInd0:6
    ...
    for plasmaFreqInd = plasmaFreqInd0:length(omega_p_Array)
        ...
        save([omega_folder_string, '\BandSqOriginal_r_by_a_', r_str],'BandSqOriginal.mat','-MAT');
        save([r_folder_string, '\BandSqOriginal_PlasmaFreq_', omega_str, '_GHz'],'BandSqOriginal.mat','-MAT');
        %% --- Plotting results
